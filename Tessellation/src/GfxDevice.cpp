...
void GfxDevice::InitVkDevice()
{
  ...
  //extensions.push_back(VK_KHR_SHARED_PRESENTABLE_IMAGE_EXTENSION_NAME);
  ...
  VkPhysicalDeviceProvokingVertexFeaturesEXT provokingVertexFeatures{
    ...
    .provokingVertexLast = VK_PROVOKING_VERTEX_MODE_LAST_VERTEX_EXT,
    .transformFeedbackPreservesProvokingVertex = VK_FALSE
  };
  vulkan13Features.pNext = &provokingVertexFeatures;
